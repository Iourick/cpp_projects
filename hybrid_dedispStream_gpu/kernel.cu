...
/* 13.03.2024 todo:*/
//to check up creating m_header with LOFAR
//obrabotat iskluchenia
//check up optimal D+max for defined signal
//and on the contrary
...
{   
    ...
    showInputString(pPathInpFile, pPathOutFold, length_of_pulse, valD_max, sigma_Bound, lenWindow);

    
    CSession_gpu* pSession = NULL;
    CSession_gpu_guppi* pSess_guppi = NULL;
    CSession_gpu_lofar* pSess_lofar = NULL;
    switch (INP_FORMAT)
    {
    case GUPPI:
